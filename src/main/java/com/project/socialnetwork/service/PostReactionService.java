...
public interface PostReactionService {
    ...
    PostReactionResponse createPostReaction(PostReactionDTO postReactionDTO, String token) throws ParserTokenException;
    void deletePostReaction(Long postreactionId, String token) throws ParserTokenException;
}
